...
--
-- Host: localhost
-- Generation Time: Aug 01, 2026 at 01:12 PM
...
CREATE TABLE `admin_acl` (
  ...
  `act_support_access` tinyint(4) NOT NULL DEFAULT '0',
  `act_vpc` tinyint(4) NOT NULL DEFAULT '0',
  `act_addvpc` tinyint(4) NOT NULL DEFAULT '0',
  `act_editvpc` tinyint(4) NOT NULL DEFAULT '0',
  `act_deletevpc` tinyint(4) NOT NULL DEFAULT '0',
  `act_secgroups` tinyint(4) NOT NULL DEFAULT '0',
  `act_vpc_natgw` tinyint(4) NOT NULL DEFAULT '0',
  `act_vpc_peering` tinyint(4) NOT NULL DEFAULT '0'
...
CREATE TABLE `bandwidth` (
  ...
  `vpcid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE `datacenters` (
  ...
  `address` text,
  `remoteagent` tinyint(1) DEFAULT '0',
  `email` varchar(255) DEFAULT NULL,
  `phone` varchar(50) DEFAULT NULL,
  `total_floors` int(11) DEFAULT '1',
  `description` text,
  `ipmi_serid` int(10) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `dc_floors`
--

CREATE TABLE `dc_floors` (
  `flid` int(11) NOT NULL,
  `dcid` int(11) NOT NULL DEFAULT '0',
  `floor_name` varchar(100) NOT NULL,
  `floor_number` int(11) NOT NULL DEFAULT '1',
  `floor_rows` int(11) DEFAULT '1',
  `floor_cols` int(11) DEFAULT '1',
  `description` text
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `dc_racks`
--
...
CREATE TABLE `dc_racks` (
  ...
  `rack_height` int(11) DEFAULT '42',
  `has_front_view` tinyint(1) DEFAULT '1',
  `has_back_view` tinyint(1) DEFAULT '1',
  `power_capacity_watts` int(11) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `servers` (
  ...
  `disable_vpc` tinyint(1) NOT NULL DEFAULT '0',
...
CREATE TABLE `storage` (
  ...
  `disk_type` varchar(10) NOT NULL DEFAULT '',
  `project_name` text,
...
CREATE TABLE `vpc` (
  ...
  `uid` int(11) NOT NULL DEFAULT '0' COMMENT 'Owner user ID; 0 = admin-owned',
  `sgid` int(11) NOT NULL DEFAULT '0',
  `serid` int(11) NOT NULL DEFAULT '0' COMMENT 'Hypervisor server ID',
  `vpc_name` varchar(100) NOT NULL,
  `description` text,
  `cidr` varchar(50) NOT NULL COMMENT 'e.g. 10.0.0.0/16',
  `gateway` varchar(50) NOT NULL COMMENT 'VPC gateway IP',
  `dns1` varchar(50) NOT NULL DEFAULT '8.8.8.8',
  `dns2` varchar(50) NOT NULL DEFAULT '8.8.4.4',
  `ovs_bridge` varchar(64) NOT NULL COMMENT 'OVS bridge name',
  `vlan_base` int(11) NOT NULL DEFAULT '100',
  `vni` int(11) NOT NULL DEFAULT '0' COMMENT 'VXLAN Network Identifier',
  `nat_enabled` tinyint(1) NOT NULL DEFAULT '0',
  `nat_public_ip` varchar(50) NOT NULL DEFAULT '',
  `nat_serid` int(11) NOT NULL DEFAULT '0',
  `nat_chain` varchar(64) NOT NULL DEFAULT '',
  `nat_bw_in` bigint(20) NOT NULL DEFAULT '0',
  `nat_bw_out` bigint(20) NOT NULL DEFAULT '0',
  `nat_bw_limit` bigint(20) NOT NULL DEFAULT '0',
  `status` tinyint(1) NOT NULL DEFAULT '1',
...
--
-- Table structure for table `vpc_ip`
--

CREATE TABLE `vpc_ip` (
  `vpcipid` int(10) NOT NULL,
  ...
  `ip` varchar(50) NOT NULL DEFAULT '',
  `mac_addr` varchar(20) DEFAULT NULL,
  `ovs_port` varchar(64) NOT NULL DEFAULT '',
  `sg_ids` text
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `vpc_node`
--

CREATE TABLE `vpc_node` (
  `vnid` int(11) NOT NULL,
  `vpcid` int(11) NOT NULL,
  `serid` int(11) NOT NULL,
  `ovs_bridge` varchar(64) NOT NULL,
  `node_ip` varchar(50) NOT NULL DEFAULT '',
  `status` tinyint(1) NOT NULL DEFAULT '1',
  `created` int(11) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `vpc_peering`
--

CREATE TABLE `vpc_peering` (
  `peerid` int(11) NOT NULL,
  `status` enum('pending','active','rejected','inactive','deleted') NOT NULL DEFAULT 'pending',
  `description` varchar(255) NOT NULL DEFAULT '',
  `vpc_a` int(11) NOT NULL,
  `uid_a` int(11) NOT NULL DEFAULT '0',
  `serid_a` int(11) NOT NULL DEFAULT '0',
  `wg_iface_a` varchar(15) NOT NULL DEFAULT '',
  `wg_pubkey_a` varchar(100) NOT NULL DEFAULT '',
  `wg_port_a` int(11) NOT NULL DEFAULT '0',
  `tunnel_ip_a` varchar(50) NOT NULL DEFAULT '',
  `vpc_b` int(11) NOT NULL,
  `uid_b` int(11) NOT NULL DEFAULT '0',
  `uid_initiator` int(11) NOT NULL DEFAULT '0',
  `serid_b` int(11) NOT NULL DEFAULT '0',
  `wg_iface_b` varchar(15) NOT NULL DEFAULT '',
  `wg_pubkey_b` varchar(100) NOT NULL DEFAULT '',
  `wg_port_b` int(11) NOT NULL DEFAULT '0',
  `tunnel_ip_b` varchar(50) NOT NULL DEFAULT '',
  `wg_psk` varchar(100) NOT NULL DEFAULT '',
  `is_mesh` tinyint(1) NOT NULL DEFAULT '0',
  `created` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `vpc_peering_mesh`
--

CREATE TABLE `vpc_peering_mesh` (
  `pmid` int(11) NOT NULL,
  `peerid` int(11) NOT NULL,
  `vpcid` int(11) NOT NULL,
  `serid` int(11) NOT NULL,
  `wg_iface` varchar(15) NOT NULL DEFAULT '',
  `wg_pubkey` varchar(100) NOT NULL DEFAULT '',
  `wg_privkey` varchar(100) NOT NULL DEFAULT '',
  `wg_port` int(11) NOT NULL DEFAULT '0',
  `mesh_ip` varchar(50) NOT NULL DEFAULT '',
  `status` tinyint(1) NOT NULL DEFAULT '1',
  `updated` int(11) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `vpc_subnet`
--

CREATE TABLE `vpc_subnet` (
  ...
  `ns2` varchar(50) NOT NULL DEFAULT '',
  `bridge` varchar(255) NOT NULL DEFAULT '',
  `ovs_bridge` varchar(100) NOT NULL DEFAULT '',
  `ovs_port` varchar(64) NOT NULL DEFAULT '',
  `vlan_tag` int(11) NOT NULL DEFAULT '0',
  `uid` int(10) NOT NULL DEFAULT '0',
  `dhcp_start` varchar(50) NOT NULL DEFAULT '',
  `dhcp_end` varchar(50) NOT NULL DEFAULT '',
  `created` int(11) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `vpc_tunnel`
--

CREATE TABLE `vpc_tunnel` (
  `vtid` int(11) NOT NULL,
  `vpcid` int(11) NOT NULL,
  `serid_local` int(11) NOT NULL,
  `serid_remote` int(11) NOT NULL,
  `tunnel_port` varchar(15) NOT NULL,
...
CREATE TABLE `vps` (
  ...
  `disable_anti_spoofing_rules` tinyint(4) NOT NULL DEFAULT '0',
  `install_xentools` int(5) NOT NULL DEFAULT '0',
  `admin_managed` int(5) NOT NULL DEFAULT '0',
...
ALTER TABLE `bandwidth`
  ADD UNIQUE KEY `vpsid` (`vpsid`,`vpcid`,`device`,`date`,`time`);
...
--
-- Indexes for table `dc_floors`
--
ALTER TABLE `dc_floors`
  ADD PRIMARY KEY (`flid`),
  ADD KEY `dcid` (`dcid`);

--
-- Indexes for table `dc_racks`
--
ALTER TABLE `dc_racks`
...
ALTER TABLE `rack_positions`
  ...
  ADD UNIQUE KEY `flid` (`flid`,`row_number`,`column_number`),
  ADD KEY `flid_idx` (`flid`);
...
--
-- Indexes for table `vpc`
--
ALTER TABLE `vpc`
  ADD PRIMARY KEY (`vpcid`),
  ADD KEY `idx_uid` (`uid`),
  ADD KEY `idx_serid` (`serid`),
  ADD KEY `idx_sgid` (`sgid`);

--
-- Indexes for table `vpc_ip`
--
ALTER TABLE `vpc_ip`
  ADD PRIMARY KEY (`vpcipid`),
  ADD KEY `idx_vpcid` (`vpcid`),
  ADD KEY `idx_subnet_id` (`subnet_id`),
  ADD KEY `idx_vpsid` (`vpsid`);

--
-- Indexes for table `vpc_node`
--
ALTER TABLE `vpc_node`
  ADD PRIMARY KEY (`vnid`),
  ADD UNIQUE KEY `idx_vpc_ser` (`vpcid`,`serid`),
  ADD KEY `idx_vpcid` (`vpcid`);

--
-- Indexes for table `vpc_peering`
--
ALTER TABLE `vpc_peering`
  ADD PRIMARY KEY (`peerid`),
  ADD UNIQUE KEY `idx_vpc_pair` (`vpc_a`,`vpc_b`),
  ADD KEY `idx_vpc_a` (`vpc_a`),
  ADD KEY `idx_vpc_b` (`vpc_b`);

--
-- Indexes for table `vpc_peering_mesh`
--
ALTER TABLE `vpc_peering_mesh`
  ADD PRIMARY KEY (`pmid`),
  ADD UNIQUE KEY `idx_peer_ser` (`peerid`,`serid`),
  ADD KEY `idx_peerid` (`peerid`);

--
-- Indexes for table `vpc_subnet`
--
ALTER TABLE `vpc_subnet`
  ADD PRIMARY KEY (`subid`),
  ADD KEY `idx_vpcid` (`vpcid`);

--
-- Indexes for table `vpc_tunnel`
--
ALTER TABLE `vpc_tunnel`
  ADD PRIMARY KEY (`vtid`),
  ADD UNIQUE KEY `idx_vpc_lr` (`vpcid`,`serid_local`,`serid_remote`),
  ADD KEY `idx_vpcid` (`vpcid`);
...
--
-- AUTO_INCREMENT for table `dc_floors`
--
ALTER TABLE `dc_floors`
  MODIFY `flid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `dc_racks`
--
ALTER TABLE `dc_racks`
...
--
-- AUTO_INCREMENT for table `vpc`
--
ALTER TABLE `vpc`
  MODIFY `vpcid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `vpc_ip`
--
ALTER TABLE `vpc_ip`
  MODIFY `vpcipid` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `vpc_node`
--
ALTER TABLE `vpc_node`
  MODIFY `vnid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `vpc_peering`
--
ALTER TABLE `vpc_peering`
  MODIFY `peerid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `vpc_peering_mesh`
--
ALTER TABLE `vpc_peering_mesh`
  MODIFY `pmid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `vpc_subnet`
--
ALTER TABLE `vpc_subnet`
  MODIFY `subid` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `vpc_tunnel`
--
ALTER TABLE `vpc_tunnel`
