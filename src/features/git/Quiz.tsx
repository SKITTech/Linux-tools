...
export default function Quiz() {
  ...
  function nextQ() { setCurrentId(pickNext()); setPicked([]); setSubmitted(false); }
  function reset() { setProg(DEFAULT_PROG); setCurrentId(pickNext()); setPicked([]); setSubmitted(false); }
