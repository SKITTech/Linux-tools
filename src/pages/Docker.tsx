...
import { Container, MessagesSquare, GraduationCap, TerminalSquare, Trophy } from "lucide-react";
import { cn } from "@/lib/utils";
import Ask from "@/features/docker/Ask";
import Learn from "@/features/docker/Learn";
import Terminal from "@/features/docker/Terminal";
import Quiz from "@/features/docker/Quiz";

type Tab = "ask" | "learn" | "terminal" | "quiz";

const TABS: { id: Tab; label: string; icon: typeof Container; desc: string }[] = [
  { id: "ask", label: "Ask Docker", icon: MessagesSquare, desc: "Q&A with copy-ready commands" },
...
export default function Docker() {
  ...
  return (
    <Sidebar>
      <SEO
        title="Docker Workspace — Learn, Ask, Practice"
        description="An interactive Docker learning workspace: AI Q&A, structured curriculum, a safe terminal sandbox, and a spaced-repetition quiz."
        path="/docker"
      />
        ...
        <header className="border-b border-border/50 bg-gradient-to-br from-primary/5 via-background to-accent/5">
          <div className="container mx-auto px-6 py-6">
            <div className="flex items-center gap-3 mb-1">
              ...
              <h1 className="text-2xl font-bold tracking-tight">Docker Workspace</h1>
            </div>
